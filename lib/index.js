...
sinonLibrary.test = sinonTest.configureTest(sinonLibrary);
sinonLibrary.testCase = sinonTest.configureTestCase(sinonLibrary);
...
/**
 * Tap testing library
 * @returns {external:tap} tap testing library
 */
const getTap = () => tap;
